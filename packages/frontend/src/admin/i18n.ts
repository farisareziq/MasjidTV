...
export let adminLang: string = localStorage.getItem(ADMIN_LANG_KEY) || 'en';
...
const I18N: Record<string, Record<string, string>> = {
  en: {
    ...
    noteStreamsCloud: '📡 {count} live stream(s) configured. Camera streams (RTSP/RTMP/ONVIF/DSHOW) and the Facebook mirror are relayed by a paired kiosk mini PC — the cloud host has no ffmpeg.',
  ...
  ms: {
    ...
    noteStreamsCloud: '📡 {count} live stream dikonfigurasi. Stream kamera (RTSP/RTMP/ONVIF/DSHOW) dan cermin Facebook direlay oleh kiosk mini PC berpasangan — hos awan tiada ffmpeg.',
